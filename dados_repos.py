...
# Salvando os dados 
ling_mais_usadas_amzn.to_csv('linguagens_amzn.csv')
ling_mais_usadas_netflix.to_csv('linguagens_netflix.csv')
ling_mais_usadas_spotify.to_csv('linguagens_spotify.csv')